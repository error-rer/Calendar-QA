  ...
  return (
    <aside className="scrl" style={vm.sidebarStyle}>
      ...
      <div style={css('padding:13px 15px 11px;border-bottom:1px solid #e7eae3')}>
        <div style={css("font-family:'IBM Plex Mono',monospace;font-size:10px;font-weight:600;color:#9aa097;letter-spacing:.6px;margin-bottom:9px")}>SYSTEM · FAB SITES</div>
...
function Toolbar({ vm }: { vm: VM }) {
  return (
    <div style={vm.toolbarStyle}>
      ...
      {vm.showViewTabs && (
        <div style={css('display:flex;background:#f1f3ee;border:1px solid #e0e3dc;border-radius:8px;padding:2px;gap:2px')}>
          <button onClick={vm.setPerson} style={vm.personTabStyle}>By engineer</button>
          <button onClick={vm.setPlant} style={vm.plantTabStyle}>By site</button>
