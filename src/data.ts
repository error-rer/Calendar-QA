...
export function initialState(): State {
  return {
    ...
    assignments: [
      ...
      { id: 'a2', eng: 'e1', order: 'o1', day: 1, appointment: 'Day', week: 0 },
      { id: 'a3', eng: 'e1', order: 'o1', day: 2, appointment: 'Day', week: 0 },
      { id: 'a4', eng: 'e10', order: 'o4', day: 0, appointment: 'Day', week: 0 },
      { id: 'a5', eng: 'e10', order: 'o4', day: 1, appointment: 'Day', week: 0 },
      { id: 'a6', eng: 'e3', order: 'o2', day: 0, appointment: 'Day', week: 0 },
      { id: 'a7', eng: 'e3', order: 'o5', day: 0, appointment: 'Day', week: 0 },
      { id: 'a8', eng: 'e4', order: 'o2', day: 2, appointment: 'Day', week: 0 },
      { id: 'a9', eng: 'e8', order: 'o2', day: 3, appointment: 'Day', week: 0 },
      { id: 'a10', eng: 'e5', order: 'o7', day: 3, appointment: 'Day', week: 0 },
      { id: 'a11', eng: 'e5', order: 'o7', day: 4, appointment: 'Day', week: 0 },
      { id: 'a12', eng: 'e8', order: 'o5', day: 4, appointment: 'Day', week: 0 },
      { id: 'a13', eng: 'e7', order: 'o3', day: 1, appointment: 'Day', week: 0 },
